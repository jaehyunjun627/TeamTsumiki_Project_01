...
/
css /login_register.css "/> ======= <link rel ="stylesheet " type ="text
	/css " href ="#"> <style>.error {
	color: red;
}
...
<body>
	...
	<div class="login-container">
		...
		<form action="LoginCon.do" method="post">
			...
			<form action="<%=request.getContextPath()%>/LoginCon.do"
				method="post">
				<p>
					이메일: <input type="email" name="userId" required>
				</p>
				<p>
					패스워드: <input type="password" name="userPw" required>
				</p>
				<p>
					<input type="submit" value="시작하기">
				</p>
				>>>>>>> branch 'main' of
				https://github.com/jaehyunjun627/TeamTsumiki_Project_01.git
			</form>
